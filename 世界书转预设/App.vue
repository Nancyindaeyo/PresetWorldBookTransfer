      ...
      <div class="pm-header-main">
        ...
        <div class="pm-version-row">
          ...
          <button
            ...
            :title="`发现新版本 v${latestVersion}，当前 v${PM_DISPLAY_VERSION}，点击打开 GitHub 更新`"
...
import { checkPresetMemoUpdate } from './lib/version-check';
import { PM_DISPLAY_VERSION, PM_HOMEPAGE } from './version';
...
function openUpdatePage() {
  window.open(PM_HOMEPAGE, '_blank', 'noopener');
}
