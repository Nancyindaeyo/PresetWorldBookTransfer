...
export const PM_DISPLAY_VERSION = bundledManifest.version;
...
export const PM_REPO_COMMITS_URL =
  'https://api.github.com/repos/Nancyindaeyo/PresetWorldBookTransfer/commits/main';

/** 当前安装包 manifest 指纹（发版时与 manifest.json 同步更新） */
export const PM_BUNDLED_MANIFEST_FINGERPRINT = fingerprintManifest(
  bundledManifest as Record<string, unknown>,
);
