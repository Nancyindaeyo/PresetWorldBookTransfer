<template>
  <div id="tab-memo" class="pm-tab-content">
    <div ref="foldersBarRef" class="pm-folders-bar">
      <div
    ...
    <div class="pm-toolbar">
      ...
      <div class="pm-toolbar-actions">
        ...
        <div class="menu_button interactable pm-btn pm-btn-danger" style="height: 32px; box-sizing: border-box" @click="batchDelete">
    ...
    <div ref="listRef" id="preset-memo-list" class="pm-list">
      ...
      >
        <div class="memo-header">
          <div class="memo-left">
            ...
            />
            <i class="fa-solid fa-chevron-right memo-toggle" @click="store.toggleMemoExpanded(entry.id)"></i>
            <PmStableField
        ...
        <div class="memo-preview" @click="onPreviewClick(entry)">{{ previewText(entry.content) }}</div>
        <PmStableField
...
function onPreviewClick(entry: MemoEntry) {
  store.toggleMemoExpanded(entry.id);
}
...
watch(() => store.sortedFolders.join(','), () => setTimeout(initFolderSortable, 50));
</script>
